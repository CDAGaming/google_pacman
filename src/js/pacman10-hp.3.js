...
function () {
  ...
  g.prepareElement = function (b, c, d) {
    ...
    if (g.useCss) {
      b.style.backgroundImage = "url(https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite-2.png)";
      b.style.backgroundPosition = -c + "px " + -d + "px";
      b.style.backgroundRepeat = "no-repeat"
    } else {
      b.style.overflow = "hidden";
      c = "display: block; position: relative; left: " + -c + "px; top: " + -d + "px";
      b.innerHTML = '<img style="' + c + '" src="https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite-2.png">'
    }
  };
  ...
  g.createKillScreenElement = function (b, c, d, f, h) {
    ...
    j.style.zIndex = 119;
    if (h) {
      j.style.background = "url(https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite-2.png) -" + g.killScreenTileX + "px -" + g.killScreenTileY + "px no-repeat";
      g.killScreenTileY += 8
  ...
  g.prepareGraphics = function () {
    g.graphicsReady = e;
    g.preloadImage("https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite-2.png")
  };
  ...
  g.prepareSound = function () {
    ...
    if (!g.hasFlash || !g.isFlashVersion("9.0.0.0")) {
      ...
      g.flashIframeDoc.write('<html><head></head><body><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=25,0,0,163" width="0" height="0" id="pacman-sound-player" type="application/x-shockwave-flash"> <param name="movie" value="https://raw.githubusercontent.com/CDAGaming/google_pacman/master/src/swf/pacman10-hp-sound.swf"> <param name="allowScriptAccess" value="always"> <object id="pacman-sound-player-2"  type="application/x-shockwave-flash" data="https://raw.githubusercontent.com/CDAGaming/google_pacman/master/src/swf/pacman10-hp-sound.swf" width="0" height="0"><param name="allowScriptAccess" value="always"> </object></object></body></html>');
