...
function () {
  ...
  g.prepareElement = function (b, c, d) {
    ...
    if (g.useCss) {
      b.style.backgroundImage = "url(https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite.png)";
      b.style.backgroundPosition = -c + "px " + -d + "px";
      b.style.backgroundRepeat = "no-repeat"
    } else {
      b.style.overflow = "hidden";
      c = "display: block; position: relative; left: " + -c + "px; top: " + -d + "px";
      b.innerHTML = '<img style="' + c + '" src="https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite.png">'
    }
  };
  ...
  g.createKillScreenElement = function (b, c, d, f, h) {
    ...
    j.style.zIndex = 119;
    if (h) {
      j.style.background = "url(https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite.png) -" + g.killScreenTileX + "px -" + g.killScreenTileY + "px no-repeat";
      g.killScreenTileY += 8
  ...
  g.prepareGraphics = function () {
    g.graphicsReady = e;
    g.preloadImage("https://raw.githubusercontent.com/yniu/google_pacman/master/src/pacman10-hp-sprite.png")
  };
